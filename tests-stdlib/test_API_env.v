...
Elpi Query lp:{{
  ...
  coq.locate "nat" GRNat, Nat = pglobal GRNat _,
  coq.locate "S" GRSucc, Succ = pglobal GRSucc _,
...
Elpi Query lp:{{
  coq.locate "False" F,
  coq.env.add-axiom "myfalse" (pglobal F _) GR,
  coq.env.opaque? GR,
...
From Stdlib Require Ranalysis5.
